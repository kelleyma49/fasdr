...
namespace Fasdr.UnitTests
{
	public static class TestData
	{
		...
		internal static readonly Entry Dir1File2 = new Entry(@"c:\dir1\file2",10,DateTime.Now,true);
		internal static readonly Entry Dir1Dir2TestStr = new Entry(@"c:\dir1\dir2\testStr",110,DateTime.Now,true);
		internal static readonly Entry Dir1TestStr = new Entry(@"c:\dir1\testStr",101,DateTime.Now.AddDays(-1),true);
